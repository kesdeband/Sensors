...
public class PressureFragment extends SensorDetailsFragment {

    private PressureModel database;
    ...
    public void onAttach(Activity activity) {
        ...
        database = new PressureModel(activity);
    }
    ...
    private class SensorEventLoggerTask extends AsyncTask<SensorEvent, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean recorded) {
            if(recorded)
                Log.d("Pressure", "Sensor data saved!");
        }
    }
}
