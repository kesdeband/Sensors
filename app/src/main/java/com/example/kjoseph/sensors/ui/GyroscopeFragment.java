...
public class GyroscopeFragment extends SensorDetailsFragment {

    private GyroscopeModel database;
    ...
    public void onAttach(Activity activity) {
        ...
        database = new GyroscopeModel(activity);
    }
    ...
    private class SensorEventLoggerTask extends AsyncTask<SensorEvent, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean recorded) {
            if(recorded)
                Log.d("Gyroscope", "Sensor data saved!");
        }
    }
}
